...
import initNewsletterModule from "../../modules/newsletter/newsletter.module.js";
...
export const registerRoutes = (app) => {
  ...
  modules.newsletter = initNewsletterModule();
  ...
  app.use("/api/newsletter", modules.newsletter.router);
