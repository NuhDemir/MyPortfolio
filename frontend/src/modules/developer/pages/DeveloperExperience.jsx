...
// Developer Mode Bileşenleri
import TerminalComponent from "../components/Developer/Terminal";
import ProjectPanel from "../components/Developer/ProjectPanel";
import CodeViewer from "../components/Developer/CodeViewer";
import ContactPanel from "../components/Developer/ContactPanel";

// Veri ve Stil
import projectsData from "@shared/data/developerProjects.json";
...
const DeveloperExperience = () => {
  ...
  return (
    ...
    >
      ...
      <Navbar
        onScrollToAbout={() => handleNavCommand("about")}
        onScrollToProjects={() => handleNavCommand("projects")}
        onScrollToContact={() => handleNavCommand("contact")}
      />
